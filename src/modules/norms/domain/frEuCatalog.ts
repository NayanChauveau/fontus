...
export const FR_EU_THRESHOLDS: ThresholdVersion[] = [
  ...
  ...pair("fluoride", "mg/L", 1.5),
  ...pair("boron", "mg/L", 1.5),
  ...pair("selenium", "µg/L", 20),
  ...pair("antimony", "µg/L", 10),
  ...pair("uranium", "µg/L", 30, {
    validFromFr: utc("2023-01-01"),
    validFromEu: PFAS_FROM,
    suffix: ":2026",
  }),
  ...pair("cyanide", "µg/L", 50),
  ...pair("bromate", "µg/L", 10),
  ...pair("manganese", "µg/L", 50, {
    kind: "quality_reference",
    binding: false,
  }),
  ...pair("sodium", "mg/L", 200, {
    kind: "quality_reference",
    binding: false,
  }),
  ...pair("chloride", "mg/L", 250, {
    kind: "quality_reference",
    binding: false,
  }),
  ...pair("sulfate", "mg/L", 250, {
    kind: "quality_reference",
    binding: false,
  }),
  {
    id: "ammonium:fr",
    parameterId: "ammonium",
    jurisdiction: "fr",
    unit: "mg/L",
    value: 0.1,
    valueMax: null,
