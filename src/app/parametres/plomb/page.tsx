...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: messages.pages.lead.title,
    description: messages.pages.lead.description,
...
export default async function LeadPage() {
  ...
  const messages = await requestMessages();
  const copy = messages.pages.lead;
  const limits = requireFrenchLegalLimits("lead", locale);
  return (
    <EditorialPage messages={messages} title={copy.title} crumb={messages.nav.lead}>
      <section>
